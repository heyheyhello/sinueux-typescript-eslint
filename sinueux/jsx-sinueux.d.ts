// JSX typings with Sinueux modifications baked in. The first 25 lines are the
// same modification as sinueux/index.d.ts tries to do, but I use a `_` prefix
// to refer to internal interfaces due to the naming conflict

import { Subject } from "./s/index.js"
...
export namespace JSXInternal {
  ...
  type DOMAttributes<Target extends EventTarget>
      = AllowSubject<
          JSXInternal._DOMAttributes<Target>
          & { children?: unknown }>

  type HTMLAttributes<RefType extends EventTarget = EventTarget>
      = AllowSubject<Omit<JSXInternal._HTMLAttributes<RefType>, 'style'>>
        & { style?:
              | MaybeSubject<string>
  ...
  type SVGAttributes<Target extends EventTarget = SVGElement>
      = AllowSubject<JSXInternal._SVGAttributes<Target>>

  type IntrinsicElements
      = AllowSubject<JSXInternal._IntrinsicElements>

  // // // // // // // // // // // // // // // // // // // // // // // // // //
  // From here down is jsx.d.ts with `_` prefixes to avoid naming conflicts
  ...
  interface _DOMAttributes<Target extends EventTarget> {
    children?: unknown;
  ...
  interface _HTMLAttributes<RefType extends EventTarget = EventTarget>
    extends _DOMAttributes<RefType> {
